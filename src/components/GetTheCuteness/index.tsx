...
export default function GetTheCuteness() {
  return (
    <section className="relative mx-auto my-10 px-2 md:px-12 lg:px-24 py-8 max-w-5xl w-full">
      {/* MOBILE LAYOUT */}
      <div className="w-full flex flex-col items-stretch md:hidden">
        ...
        <div className="flex flex-row w-full min-h-[300px]">
          ...
          <div className="text-[15px] text-[#1C007C] font-medium text-right max-w-[150px] sm:max-w-[200px] mt-6 pr-5">
      ...
      {/* DESKTOP LAYOUT (carousel chuyển động như cũ) */}
