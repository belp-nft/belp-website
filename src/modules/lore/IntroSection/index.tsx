      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              From the playful purple cats to the wise rainbow friends, discover
              the magical world where friendship and wonder never end. Every
              character has a story to tell and dreams to share with you!
            </motion.p>
