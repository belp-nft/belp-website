  ...
  return (
    <section
      className={clsx(
        ...
        "py-12 md:py-16 lg:py-[60px]"
      )}
      style={{
        background: "linear-gradient(180deg, #f2ecf6 0%, #fff 100%)",
      }}
    >
      <div className="px-6 sm:px-10 md:px-20 lg:px-[224px]">
        <motion.h1
          className={clsx(
        ...
        <p className="mb-[92px] sm:text-responsive-lg">
          Meet Belpy, the adorable Web3-born character that's taking the digital
          universe by storm. Born from the cosmic dreams of creators and the
          infinite imagination of the community.
        </p>
      </div>
      <div className="md:px-20 lg:px-[224px]">
        <CatCarousel />
      </div>
    </section>
  );
